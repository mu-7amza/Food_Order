...
public class PlaceYourOrderActivity extends AppCompatActivity {
    ...
    public EditText inputName, inputAddress, inputCity, inputState, inputZip,inputCardNumber, inputCardExpiry, inputCardPin ;
    public RecyclerView cartItemsRecyclerView;
    public TextView tvSubtotalAmount, tvDeliveryChargeAmount, tvDeliveryCharge, tvTotalAmount, buttonPlaceYourOrder,moveToCrudPage;
    public SwitchCompat switchDelivery;
    public boolean isDeliveryOn;
    public PlaceYourOrderAdapter placeYourOrderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        moveToCrudPage = findViewById(R.id.moveToCrudPage);
        ...
        buttonPlaceYourOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                Boolean result = dbConnectionForOrders.insertOrderData(Name,CardNumber,CardExpiry,CardPin,Total);
                if(result == true){
                    Toast.makeText(PlaceYourOrderActivity.this,"Successful" ,Toast.LENGTH_SHORT ).show();

                }else {
                    Toast.makeText(PlaceYourOrderActivity.this," Failed" ,Toast.LENGTH_SHORT ).show();

                }
            }
        });

        // TextView (Move to crudOrders Page) Activation
        moveToCrudPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), crudOrders.class);
